...
class ReferenciaBibliograficaSpec(unittest.TestCase):
    ...
    def teste_monta_nome(self):
        ...
        montar_nome._monta_nome('Ruhan Ferreira Almeida; Carlos Souza Teste') |should| equal_to ('ALMEIDA, R. F.; TESTE, C. S.')
    ...
    def testa_referencia_de_trabalho_conclusao(self):
        ...
        with Stub() as trabalho_conclusao:
            ...
            trabalho_conclusao.titulo >> 'Contribuição do alerta, da atenção, da intenção e da expectativa temporal para o desempenho de humanos em tarefas de tempo de reação'
            ...
            trabalho_conclusao.instituicao >> 'Instituto de Psicologia, Universidade de São Paulo'
            trabalho_conclusao.local_defesa >> 'São Paulo'
        referencia_abnt = referencia.gera_referencia(trabalho_conclusao)
        referencia_abnt |should| equal_to('FANTUCCI, I. Contribuição do alerta, da atenção, da intenção e da expectativa temporal para o desempenho de humanos em tarefas de tempo de reação. 2001. 130 f. Tese (Doutorado em Psicologia) - Instituto de Psicologia, Universidade de São Paulo, São Paulo.')
    ...
    def testa_referencia_de_artigo_anais_evento(self):
        ...
        with Stub() as artigo_anais_evento:
            ...
            artigo_anais_evento.titulo >> 'Multiculturalismo, Currículo e Formação de Professores'
            artigo_anais_evento.subtitulo >> None
            artigo_anais_evento.nome_evento >> 'SEMINÁRIO ESTADUAL DE EDUCAÇÃO BÁSICA'
        ...
        referencia_abnt |should| equal_to('MOREIRA, A. F. B. Multiculturalismo, Currículo e Formação de Professores. In: SEMINÁRIO ESTADUAL DE EDUCAÇÃO BÁSICA, 2., 1998, Santa Cruz do Sul. Anais. Santa Cruz do Sul: EDUNISC, 1998. P. 15-30.')
    ...
    def testa_referencia_de_artigo_periodico(self):
        ...
        with Stub() as artigo_periodico:
            ...
            artigo_periodico.titulo >> 'A Universidade e a Problemática da Educação e Cultura'
        ...
        referencia_abnt |should| equal_to('SAVIANI, D. A Universidade e a Problemática da Educação e Cultura. Educação Brasileira, Brasília, v. 1, n. 3, p. 35-58, 1979.')
    ...
    def testa_referencia_de_periodico_tecnico_cientifico(self):
        ...
        referencia_abnt |should| equal_to('EDUCAÇÃO & REALIDADE. Porto Alegre: UFRGS/FACED, 1975-')

    def testa_referencia_de_livro(self):
        referencia = ReferenciaBibliografica()
        with Stub() as livro:
            livro.tipo >> 'livro'
            livro.autores >> 'Marcos Antônio Azevedo; Vinícios Nogueira Almeida Guerra'
            livro.titulo >> 'Mania de bater'
            livro.subtitulo >> 'a punição corporal doméstica de crianças e adolescentes no Brasil'
            livro.traducao >> None
            livro.edicao >> None
        ...
        referencia_abnt |should| equal_to('AZEVEDO, M. A.; GUERRA, V. N. A. Mania de bater: a punição corporal doméstica de crianças e adolescentes no Brasil. São Paulo: Iglu, 2001. 386 p.')
    ...
    def testa_referencia_de_relatorio_tecnico_cientifico(self):
        ...
        with Stub() as relatorio_tecnico_cientifico:
            ...
            relatorio_tecnico_cientifico.autores >> 'Ubiraci Espinelli Lemes Souza; Silvio Burratino Melhado'
            relatorio_tecnico_cientifico.titulo >> 'Subsídios para a avaliação do custo de mão-de-obra na construção civil'
        ...
        referencia_abnt |should| equal_to('SOUZA, U. E. L.; MELHADO, S. B. Subsídios para a avaliação do custo de mão-de-obra na construção civil. São Paulo: EPUSP, 1991. 38 p.')
